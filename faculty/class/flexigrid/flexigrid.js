		...
		if (p.searchitems)
			{
				...
				$('input[value=Clear]',g.sDiv).click(function(){ $('.ftitle').html($('#aysem').val()); $('select[name=qtype]').val('Select Academic Year & Semester'); $('input[name=q]',g.sDiv).val(''); p.query = ''; g.doSearch(); });
				$(g.bDiv).after(g.sDiv);				
